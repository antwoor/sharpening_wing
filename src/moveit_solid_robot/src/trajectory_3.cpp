...
{
    std::ifstream infile("/home/antwoor/moveit_ws/src/moveit_solid_robot/src/inv_waypoints.txt"); // Открыть текстовый файл для чтения
    std::string line;
    tf2::Quaternion ori;
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "moveit_trajectory_planning3");
    ...
    //планируем маршрут
    planner(trajectory, 0.0008, -0.052237, -0.20, 0.34688);
